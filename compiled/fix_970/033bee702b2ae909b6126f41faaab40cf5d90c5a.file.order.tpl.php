<?php /* Smarty version Smarty-3.0.7, created on 2015-12-25 10:26:15
         compiled from "/home/a100shub/100shub.ru/www//design/fix_970/html/order.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1832324231567cef972e79d7-52532963%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '033bee702b2ae909b6126f41faaab40cf5d90c5a' => 
    array (
      0 => '/home/a100shub/100shub.ru/www//design/fix_970/html/order.tpl',
      1 => 1450814621,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1832324231567cef972e79d7-52532963',
  'function' => 
  array (
  ),
...
>
			...
			<label for=payment_<?php echo $_smarty_tpl->getVariable('payment_method')->value->id;?>
>	
				<h3><?php echo $_smarty_tpl->getVariable('payment_method')->value->name;?>
...
<h2>
К оплате <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['convert'][0][0]->convert($_smarty_tpl->getVariable('order')->value->total_price,$_smarty_tpl->getVariable('payment_method')->value->currency_id);?>
&nbsp;<?php echo $_smarty_tpl->getVariable('currencies')->value[$_smarty_tpl->getVariable('payment_method')->value->currency_id]->sign;?>
