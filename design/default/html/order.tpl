    ...
    {foreach $payment_methods as $payment_method}
    	<li>
			...
			<label for=payment_{$payment_method->id}>	
				<h3>{$payment_method->name}, к оплате {$order->total_price|convert:$payment_method->currency_id}&nbsp;{$all_currencies[$payment_method->currency_id]->sign}</h3>
