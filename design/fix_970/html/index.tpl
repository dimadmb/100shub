...
<body>
	...
	<!-- Шапка -->
			<div id="header">
				<!-- Логотип -->
			<div id="logo"><a href="/"><img src="design/{$settings->theme|escape}/images/logo.png" title="{$settings->site_name|escape}" alt="{$settings->site_name|escape}"/></a>
                         <div id="phone">
			...
			<!-- Логотип (The End) -->
							...
							<a data-page="{$p->id}" href="{$p->url}">{$p->name|escape}</a>
								...
								<ul>
									{foreach $categories as $category}
										{if (($category->visible == 1) && ($category->id != 6))}
				...
				<!-- Главное меню (The End)-->
                            ...
                            <div id="banner">
                                <a href="/sale"><img src="design/{$settings->theme|escape}/images/banner2.png" /></a>
                         	</div>
			</div>
			<!-- Шапка (The End)-->
