$(function() {
	...
	$('[page_id]').live('mouseover', show_tooltip);	
	$('[category_id]').live('mouseover', show_tooltip);
	$('[brand_id]').live('mouseover', show_tooltip);
	$('[product_id]').live('mouseover', show_tooltip);
	$('[post_id]').live('mouseover', show_tooltip);
	$('[feature_id]').live('mouseover', show_tooltip);
});
...
function show_tooltip()
{
	...
	if(id = $(this).attr('page_id'))
	{
		content = "<a href='simpla/index.php?module=PageAdmin&id="+id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
		content += "<a href='simpla/index.php?module=PageAdmin&return="+from+"' class=admin_tooltip_add>Добавить страницу</a>";
	}
		
	if(id = $(this).attr('category_id'))
	{
		content = "<a href='simpla/index.php?module=CategoryAdmin&id="+id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
		content += "<a href='simpla/index.php?module=ProductAdmin&category_id="+id+"&return="+from+"' class=admin_tooltip_add>Добавить товар</a>";
	}
	
	if(id = $(this).attr('brand_id'))
	{
		content = "<a href='simpla/index.php?module=BrandAdmin&id="+id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
	}
	
	if(id = $(this).attr('product_id'))
	{
		content = "<a href='simpla/index.php?module=ProductAdmin&id="+id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
	}
	
	if(id = $(this).attr('post_id'))
	{
		content = "<a href='simpla/index.php?module=PostAdmin&id="+id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
	}

	if(id = $(this).attr('feature_id'))
	{
		content = "<a href='simpla/index.php?module=FeatureAdmin&id="+id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
	}
	
	$('.tooltipBody').html(content);
}
