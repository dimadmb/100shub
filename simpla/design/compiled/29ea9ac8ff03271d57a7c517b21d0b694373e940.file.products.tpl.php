<?php /* Smarty version Smarty-3.0.7, created on 2015-12-28 13:31:06
         compiled from "simpla/design/html/products.tpl" */ ?>
<?php /*%%SmartyHeaderCode:57923009256810f6a30b318-30754380%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '57923009256810f6a30b318-30754380',
  'function' => 
  array (
    'category_select' => 
    array (
...
if (!is_callable('smarty_modifier_truncate')) include '/home/users/1/12nas24/domains/vodohod-moscow.ru/Smarty/libs/plugins/modifier.truncate.php';
?>
<?php ob_start(); ?>
...
?>
		<div class="<?php if (!$_smarty_tpl->getVariable('product')->value->visible){?>invisible<?php }?> <?php if ($_smarty_tpl->getVariable('product')->value->hit){?>hit<?php }?> row">
...
">Все товары</a></li>
		<li <?php if ($_smarty_tpl->getVariable('filter')->value=='hits'){?>class="selected"<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('keyword'=>null,'brand_id'=>null,'category_id'=>null,'page'=>null,'filter'=>'hits'),$_smarty_tpl);?>
">Лучшие товары</a></li>
...
'},
	...
	$("a.hit").click(function() {
		...
		$.ajax({
			type: 'POST',
			url: 'ajax/update_object.php',
			data: {'object': 'product', 'id': id, 'values': {'hit': state}, 'session_id': '<?php echo $_SESSION['id'];?>
'},
			success: function(data){
				icon.removeClass('loading_icon');
				if(state)
