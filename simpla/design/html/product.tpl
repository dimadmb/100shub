...
<input type=hidden name="session_id" value="{$smarty.session.id}">
 	...
 	<div id="name">
		...
		<div class="checkbox">
			<input name=hit value="1" type="checkbox" id="hit_checkbox" {if $product->hit}checked{/if}/> <label for="hit_checkbox">Хит</label>
		</div>
	</div> 
		...
		<ul>
			...
			<li class="variant_download">
				...
				<div class=browse_attachment style='display:none;'>
					<input type=file name=attachment[{$variant->id}]>
				</div>
