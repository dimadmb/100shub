...
<input type=hidden name="session_id" value="{$smarty.session.id}">
		...
		<div class="block">
			...
			<ul>
				...
				<li><label class=property>Процентная ставка</label><input name="prozent_stavka" class="simpla_inp" type="text" value="{$settings->prozent_stavka|escape}" /></li>

				<textarea name="news_text"  class="editor_large">{$settings->news_text}</textarea>
